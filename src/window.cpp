...
void LaunchGui(const char* glsl_version, Inputs* inputs, SDL_Event event)
{
    ...
    SDL_Window* window = SDL_CreateWindow("Spaghet about it!", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1280, 720, window_flags);
...
//game
    ...
    Game* game = new Game(window, inputs, TextureID);
...
void Window::Init(Inputs* inputs)
{
    ////Initialize SDL
    ...
    else
    {
        ...
        LaunchGui(glsl_version, inputs, mEvent);
