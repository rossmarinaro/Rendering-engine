...
OBJS = src/main.cpp src/entities/sprite.cpp src/entities/player.cpp src/map.cpp src/audio.cpp src/window.cpp src/game.cpp vendors/imgui/imgui.cpp vendors/imgui/imgui_demo.cpp vendors/imgui/imgui_widgets.cpp vendors/imgui/imgui_tables.cpp vendors/imgui/imgui_draw.cpp vendors/imgui/imgui_impl_sdl.cpp vendors/imgui/imgui_impl_opengl3.cpp 
